...
export default [
  ...
  {
    description: 'ANIMAL:NORTHERN_LYNX_DESCRIPTION',
    habitatPrimary: ['highland forests and grasslands'],
    habitatSecondary: ['lowland forest'],
    heading: 'ANIMAL:NORTHERN_LYNX_HEADING',
    hitEnergy: [1098, 2950],
    latin: 'ANIMAL:NORTHERN_LYNX_LATIN',
    lifeCycle: [
      { activity: 'sleeping', time: 2 },
      { activity: 'feeding', time: 5 },
      { activity: 'drinking', time: 9 },
