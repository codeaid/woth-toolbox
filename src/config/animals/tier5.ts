...
export default [
  ...
  {
    description: 'ANIMAL:MOUNTAIN_REINDEER_DESCRIPTION',
    habitatPrimary: ['highlands'],
    habitatSecondary: ['highland forests and grasslands'],
    heading: 'ANIMAL:MOUNTAIN_REINDEER_HEADING',
    hitEnergy: [1515, 3721],
    latin: 'ANIMAL:MOUNTAIN_REINDEER_LATIN',
    lifeCycle: [
      { activity: 'drinking', time: 0 },
      { activity: 'sleeping', time: 2 },
      { activity: 'feeding', time: 7 },
    ...
    maps: ['lintukoto'],
    slug: 'mountain-reindeer',
    tier: 5,
    type: 'animal:mountain reindeer',
  },
  {
