...
>([
  ...
  ['animal:arctic fox', icons.ArcticFoxIcon],
  ...
  ['animal:eastern wild turkey', icons.EasternWildTurkeyIcon],
  ['animal:egyptian goose', icons.EgyptianGooseIcon],
  ['animal:eurasian badger', icons.EurasianBadgerIcon],
  ['animal:eurasian moose', icons.EurasianMooseIcon],
  ['animal:eurasian wolverine', icons.EurasianWolverineIcon],
  ...
  ['animal:mountain reindeer', icons.MountainReindeerIcon],
  ['animal:mule deer', icons.MuleDeerIcon],
  ['animal:northern lynx', icons.NorthernLynxIcon],
